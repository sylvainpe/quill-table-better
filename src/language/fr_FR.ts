export default {
  'col': 'Colonne',
  'insColL': 'Insérer une colonne à gauche',
  'insColR': 'Insérer une colonne à droite',
  'delCol': 'Supprimer la colonne',
  'row': 'Ligne',
  'insRowAbv': 'Insérer une ligne au-dessus',
  'insRowBlw': 'Insérer une ligne en dessous',
  ...
  'insParaOTbl': 'Insérer un paragraphe en dehors du tableau',
  'insB4': 'Insérer avant',
